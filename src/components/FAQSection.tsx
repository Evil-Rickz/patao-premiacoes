...
export function FAQSection() {
  ...
  return <section id="faq" className="py-16 bg-background">
                ...
                <CollapsibleTrigger className="w-full">
                  <CardHeader className="hover:bg-secondary/50 transition-colors">
                    <div className="flex items-center justify-between">
                      ...
                      <ChevronDown className={cn("h-5 w-5 text-muted-foreground transition-transform duration-200 flex-shrink-0", openItems.has(index) ? "transform rotate-180" : "")} />
                    </div>
                  </CardHeader>
                </CollapsibleTrigger>
                <CollapsibleContent>
            ...
            <CardContent className="pt-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <div className="text-center">
                  ...
                  <div className="text-primary">(98) 98135-0326</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold">E-mail</div>
                  <div className="text-primary">contato@pataopremiacoes.com.br</div>
                </div>
                <div className="text-center">
